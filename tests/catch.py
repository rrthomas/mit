...
pushrel(M.start + 0x200)
correct.append([8, 5, 2, 2, M.start + 0x200])
extra(CATCH)
ret_addr = label()
goto(M.start + 0x200)
...
pushrel(M.start + 0x400)
correct.append([1, 3, 0, 3, 0, 2, 2, M.start + 0x400])
extra(CATCH)
ret_addr = label()
goto(M.start + 0x400)
...
push(0)
correct.append([0, 0])
pushrel(M.start + 0x600)
correct.append([0, 0, M.start + 0x600])
extra(CATCH)
ret_addr = label()
goto(M.start + 0x600)
