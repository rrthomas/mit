...
\inst{GET\_STACK\_DEPTH}{— u}{\spic{u} is the value of {\tt STACK\_DEPTH}, the number of words on the stack.}
...
This instruction is a general-purpose escape. In contrast to extra instructions, which are intended to be frequently used and potentially optimized, {\tt EXT}’s behaviour is not defined; in particular, it has an arbitrary stack effect.

\nopagebreak
\begin{description}
\inst{EXT}{}{Perform arbitrary actions.}
\end{description}
...
\opcodetbl{07}{undefined}	{17}{UDIVMOD}
